export const SkillCard = ({ icon: Icon, title }) => {
  return (
    <div className="group w-[190px] h-[120px] bg-black text-center rounded-2xl shadow-inner transition-all duration-500 hover:h-[180px] border-2 border-teal-400 hover:shadow-[0_0_25px_3px_rgba(45,212,191,0.7)]">
